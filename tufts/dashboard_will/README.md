...
1. Download the entire prod dashboard folder (link coming soon)
2. Run the following commands to add the code to your sandbox apps:

```bash
mkdir ondemand/prod/dashboard
cp /path_to_downloads/new_tufts_dashboard /cluster/home/[your username]/ondemand/prod/dashboard/
```
